...
export class AddBorrowRecords1769608976557 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."borrow_records_status_enum" AS ENUM('borrowed', 'returned', 'overdue')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_a7a3485206681944a704936f13" ON "borrow_records" ("user_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_ffe42824c6619410ae86622542" ON "borrow_records" ("book_id") `,
    );
    await queryRunner.query(
      `ALTER TABLE "borrow_records" ADD CONSTRAINT "FK_a7a3485206681944a704936f130" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "borrow_records" DROP CONSTRAINT "FK_a7a3485206681944a704936f130"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_ffe42824c6619410ae86622542"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_a7a3485206681944a704936f13"`,
    );
